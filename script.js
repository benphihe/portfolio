...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.article-card, .mission-card, .tache-card, .competence-category');
...
// Compteur animé pour les statistiques (si ajoutées plus tard)
